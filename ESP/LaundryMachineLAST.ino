...
const char* STATION_SSID_PRIMARY = "TECNO";
const char* STATION_PASSWORD_PRIMARY = "qazwsx12";
const char* STATION_SERVER_URL_PRIMARY = "http://10.114.93.122:5000/scan_card";

// Secondary WiFi (Fallback - Dormitory WiFi)
const char* STATION_SSID_SECONDARY = "DUZCEYURDU";
const char* STATION_PASSWORD_SECONDARY = "duzceyurdu34!";
const char* STATION_SERVER_URL_SECONDARY = "http://172.16.3.191:5000/scan_card";
...
const char* currentFirmwareVersion = "1.0.6";
